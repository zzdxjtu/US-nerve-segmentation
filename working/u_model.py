...
def get_unet_customised(optimizer, pars=PARS, allowed_pars=ALLOWED_PARS):
    ...
    print('conv5', conv5._keras_shape)
    f1 = Conv2D(1, kernel_size=(1, 1), kernel_initializer='he_normal')(conv5)
    f1 = UpSampling2D(size=(2, 2))(f1)
    f1 = UpSampling2D(size=(2, 2))(f1)
    f1 = UpSampling2D(size=(2, 2))(f1)
    f1 = UpSampling2D(size=(2, 2))(f1)
    print('f1', f1._keras_shape)
    ...
    conv6 = attach_attention_module(conv6, attention_module='cbam_block')
    conv6 = Dropout(0.5)(conv6)
    print('conv6', conv6._keras_shape)
    f2 = Conv2D(1, kernel_size=(1, 1), kernel_initializer='he_normal')(conv6)
    f2 = UpSampling2D(size=(2, 2))(f2)
    f2 = UpSampling2D(size=(2, 2))(f2)
    f2 = UpSampling2D(size=(2, 2))(f2)
    print('f2', f2._keras_shape)
    ...
    conv7 = attach_attention_module(conv7, attention_module='cbam_block')
    conv7 = Dropout(0.5)(conv7)
    print('conv7', conv7._keras_shape)
    f3 = Conv2D(1, kernel_size=(1, 1), kernel_initializer='he_normal')(conv7)
    f3 = UpSampling2D(size=(2, 2))(f3)
    f3 = UpSampling2D(size=(2, 2))(f3)
    print('f3', f3._keras_shape)
    ...
    conv8 = attach_attention_module(conv8, attention_module='cbam_block')
    conv8 = Dropout(0.5)(conv8)
    print('conv8', conv8._keras_shape)
    f4 = Conv2D(1, kernel_size=(1, 1), kernel_initializer='he_normal')(conv8)
    f4 = UpSampling2D(size=(2, 2))(f4)
    print('f4', f4._keras_shape )
    ...
    conv9 = attach_attention_module(conv9, attention_module='cbam_block')
    conv9 = Dropout(0.5)(conv9)
    print('conv9', conv9._keras_shape)
    sum = concatenate([f1, f2, f3, f4, conv9], axis=3)
    print('sum', sum._keras_shape)
